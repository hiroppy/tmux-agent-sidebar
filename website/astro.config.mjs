...
const DESCRIPTION =
  'tmux-agent-sidebar — one tmux sidebar that tracks every Claude Code, Codex, Grok Build, and OpenCode pane across every session and window. See status, prompts, Git state, activity, and worktrees without switching windows.';
