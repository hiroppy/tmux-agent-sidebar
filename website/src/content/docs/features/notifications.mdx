...
| ------------------- | --------------------------------------------------------- | ---------------- | ------- |
| `stop`              | Assistant finished responding (`Stop` hook)               | Claude, Codex, Grok, OpenCode | ✓       |
| `notification`      | Permission prompt or other attention request              | Claude, Grok, OpenCode | ✓       |
| `stop_failure`      | Assistant ended with an error (`StopFailure` hook)        | Claude, Grok, OpenCode | ✓       |
| `permission_denied` | Permission explicitly denied (`PermissionDenied` hook)    | Claude, Grok      | ✓       |
