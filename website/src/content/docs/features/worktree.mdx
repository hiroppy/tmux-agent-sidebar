...
The sidebar can create a git worktree, open a new tmux window, and launch an agent in it — all from one keystroke. Closing is symmetric: window, worktree, and branch go together.
