...
- **tmux window** — the slug is used as the window name; the agent you picked in the modal (`claude` / `codex` / `grok` / `opencode`) launches inside it with the selected permission `MODE`.
