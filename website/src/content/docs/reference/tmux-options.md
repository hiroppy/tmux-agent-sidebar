...
| Option                            | Default     | Description                                               |
| --------------------------------- | ----------- | --------------------------------------------------------- |
| `@agent-sidebar-default-agent`    | `claude`    | Agent launched by `n`&nbsp;(also accepts `codex`, `opencode`, `agy`) |
...
| `@sidebar_color_agent_agy` | `150`&nbsp;(light green) | Antigravity CLI agent color |
