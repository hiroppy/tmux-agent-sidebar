...
impl ColorTheme {
    ...
    fn from_options(all_opts: &std::collections::HashMap<String, String>) -> Self {
        ...
        theme.agent_agy = read(tmux::SIDEBAR_COLOR_AGENT_AGY, theme.agent_agy);
    ...
    pub fn agent_color(&self, agent: &AgentType) -> Color {
        match agent {
            ...
            AgentType::Antigravity => self.agent_agy,
...
mod tests {
    ...
    #[test]
    fn antigravity_color_is_configurable() {
        let options = std::collections::HashMap::from([(
            tmux::SIDEBAR_COLOR_AGENT_AGY.into(),
            "#abcdef".into(),
        )]);
        assert_eq!(
            ColorTheme::from_options(&options).agent_color(&AgentType::Antigravity),
