...
pub use options::{
    ...
    SIDEBAR_COLOR_AGENT_OMP, SIDEBAR_COLOR_AGENT_OPENCODE, SIDEBAR_COLOR_ALL, SIDEBAR_COLOR_BORDER,
...
pub use types::{
    AgentType, CLAUDE_AGENT, CODEX_AGENT, OMP_AGENT, OPENCODE_AGENT, PaneInfo, PaneStatus,
