...
pub use options::{
    ...
    PANE_OS_NOTIFY_TASK_FAILED, PANE_PENDING_SESSION_END, PANE_PENDING_STOP_NOTIFICATION_BODY,
    ...
    SIDEBAR_COLOR_AGENT_CLAUDE, SIDEBAR_COLOR_AGENT_CODEX, SIDEBAR_COLOR_AGENT_GROK,
