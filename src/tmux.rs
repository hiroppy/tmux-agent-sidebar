...
pub use options::{
    ...
    SIDEBAR_COLOR_AGENT_OPENCODE, SIDEBAR_COLOR_AGENT_OMP, SIDEBAR_COLOR_ALL, SIDEBAR_COLOR_BORDER, SIDEBAR_COLOR_BRANCH,
...
pub use types::{
    AgentType, CLAUDE_AGENT, CODEX_AGENT, OPENCODE_AGENT, OMP_AGENT, PaneInfo, PaneStatus, PermissionMode,
