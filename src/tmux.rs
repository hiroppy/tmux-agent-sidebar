...
pub use options::{
    ...
    SIDEBAR_COLOR_AGENT_DEVIN, SIDEBAR_COLOR_AGENT_OPENCODE, SIDEBAR_COLOR_ALL,
...
pub use types::{
    AgentType, CLAUDE_AGENT, CODEX_AGENT, DEVIN_AGENT, OPENCODE_AGENT, PaneInfo, PaneStatus,
