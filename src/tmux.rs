...
pub use options::{
    ...
    SIDEBAR_COLOR_WAITING, SIDEBAR_CURSOR, SIDEBAR_FILTER, SIDEBAR_GIT_OPEN_COMMAND,
    SIDEBAR_GIT_OPEN_PANE, SIDEBAR_GIT_OPEN_TARGET, SIDEBAR_ICON_ALL, SIDEBAR_ICON_BACKGROUND,
